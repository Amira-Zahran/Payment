...
class PaymentCubit extends Cubit<PaymentStates>{
  ...
  Future getFirstToken(String price, String firstname, String lastname, String email, String phone) async{
    DioHelperPayment.postDate(url: 'auth/tokens', data: {'api_key': PaymobApiKey}).then((value) {
  ...
  Future getFinalTokenCard(String price, String firstname, String lastname, String email, String phone) async{
    DioHelperPayment.postDate(url: 'acceptance/payment_keys', data: {
        "auth_token": PaymobToken,
        "amount_cents": price,
        "expiration": 3600,
  ...
  Future getRefCode() async{
    DioHelperPayment.postDate(url: 'acceptance/payments/pay', data: {
      "source": {
